...
export function ProfileIcon({ color }: ProfileProps) {
  ...
  14.5 15 15.4 16.6 17M2.49997 14C1.89997 12.8 1.49997 11.4 1.49997 10C1.49997 5 5.49997 1 10.5 1C15.5 1 19.5 5 19.5 10C19.5
  11.4 19.1 12.8 18.5 14" stroke=${color || '#666666'} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
