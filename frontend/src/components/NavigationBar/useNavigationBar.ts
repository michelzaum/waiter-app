...
const links = [
  { id: 1, icon: HomeIcon, linkText: 'Home' },
  { id: 2, icon: HistoryIcon, linkText: 'Histórico' },
  { id: 3, icon: MenuIcon, linkText: 'Cardapio' },
  { id: 4, icon: UsersIcon, linkText: 'Usuários' },
];

const personalLinks = [
  { id: 5, icon: ProfileIcon, linkText: 'Meu Perfil' },
  { id: 6, icon: ExitIcon, linkText: 'Sair' },
];
